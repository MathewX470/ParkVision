...
try:
    with open("parking_slots2.json", "r") as f:
...
# Resize frame if too large (max 1280 width while keeping aspect ratio)
max_width = 1280
h, w = frame.shape[:2]
if w > max_width:
    scale = max_width / w
